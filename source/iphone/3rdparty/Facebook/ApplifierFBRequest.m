...
@implementation ApplifierFBRequest
...
+ (ApplifierFBRequest *)getRequestWithParams:(NSMutableDictionary *) params
  ...
  ApplifierFBRequest* request = [[[ApplifierFBRequest alloc] init] autorelease];
...
- (id)parseJsonResponse:(NSData *)data error:(NSError **)error {
  ...
  NSString* responseString = [[[NSString alloc] initWithData:data
                              ...
                              autorelease];
  ApplifierSBJSON *jsonParser = [[ApplifierSBJSON new] autorelease];
