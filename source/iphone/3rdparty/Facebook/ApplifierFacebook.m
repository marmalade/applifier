...
@implementation ApplifierFacebook
 ...
 */
- (ApplifierFBRequest*)openUrl:(NSString *)url
               params:(NSMutableDictionary *)params
           httpMethod:(NSString *)httpMethod
             delegate:(id<ApplifierFBRequestDelegate>)delegate {
  ...
  [_request release];
  _request = [[ApplifierFBRequest getRequestWithParams:params
...
- (void)authorizeWithFBAppAuth:(BOOL)tryFBAppAuth
  ...
  if ([device respondsToSelector:@selector(isMultitaskingSupported)] && [device isMultitaskingSupported]) {
    if (tryFBAppAuth) {
      ...
      NSString *fbAppUrl = [ApplifierFBRequest serializeURL:urlPrefix params:params];
    ...
    if (trySafariAuth && !didOpenOtherApp) {
      ...
      NSString *fbAppUrl = [ApplifierFBRequest serializeURL:loginDialogURL params:params];
      didOpenOtherApp = [[UIApplication sharedApplication] openURL:[NSURL URLWithString:fbAppUrl]];
    }
  }
  ...
  if (!didOpenOtherApp) {
    [_loginDialog release];
    _loginDialog = [[ApplifierFBLoginDialog alloc] initWithURL:loginDialogURL
                                          loginParams:params
                                             delegate:self];
    [_loginDialog show];
  }
...
- (void)dialog:(NSString *)action
  ...
  if (action == kLogin) {
    ...
    _fbDialog = [[ApplifierFBLoginDialog alloc] initWithURL:dialogURL loginParams:params delegate:self];
  } else {
    ...
    _fbDialog = [[ApplifierFBDialog alloc] initWithURL:dialogURL params:params delegate:delegate];
  }
 ...
 */
- (void)request:(ApplifierFBRequest*)request didFailWithError:(NSError*)error{
