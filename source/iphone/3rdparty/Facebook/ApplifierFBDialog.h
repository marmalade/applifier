...
@protocol ApplifierFBDialogDelegate;
...
@interface ApplifierFBDialog : UIView <UIWebViewDelegate> {
  id<ApplifierFBDialogDelegate> _delegate;
 ...
 * The delegate.
 */
@property(nonatomic,assign) id<ApplifierFBDialogDelegate> delegate;
...
- (id)initWithURL: (NSString *) loadingURL
         ...
         delegate: (id <ApplifierFBDialogDelegate>) delegate;
 ...
 */
@protocol ApplifierFBDialogDelegate <NSObject>
 ...
 */
- (void)dialogDidComplete:(ApplifierFBDialog *)dialog;
 ...
 */
- (void)dialogDidNotComplete:(ApplifierFBDialog *)dialog;

/**
 * Called when dialog failed to load due to an error.
 */
- (void)dialog:(ApplifierFBDialog*)dialog didFailWithError:(NSError *)error;
 ...
 */
- (BOOL)dialog:(ApplifierFBDialog*)dialog shouldOpenURLInExternalBrowser:(NSURL *)url;
